const experiences = [
  ...
  },
  {
    ...
    company: "Self-Learning",
    description:
      "Learned the fundamentals of programming including problem solving, data structures, and basic software development concepts using C++, C#, and SQL.",
  ...
  },
  {
    ...
    description:
      "Started my programming journey by learning the basics of C++. Spent several hours daily practicing and building a strong foundation in programming concepts.",
    technologies: ["C++"],
    current: false,
  },
];
    ...
    <section id="experience" className="py-32  relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-5xl px-6 relative z-10">
        ...
        <div className="max-w-3xl mb-16">
          ...
          >
            A look at my journey in programming and the milestones that shaped
